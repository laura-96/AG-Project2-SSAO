#ifndef TEXTURINGGLWIDGET_H
#define TEXTURINGGLWIDGET_H
...
class TexturingGLWidget : public QOpenGLWidget, protected QOpenGLFunctions_3_3_Core
{
    Q_OBJECT

public:
    TexturingGLWidget(QWidget *parent = 0);
    ~TexturingGLWidget();
...
private:
	...
	float m_sceneRadius;
	GLuint m_VAO, m_VBOVerts, m_VBONorms, m_VBOCols, m_VBOTexCoords;
	QColor m_bkgColor;
	...
	GLuint m_vertexLoc, m_normalLoc, m_colorLoc, m_texCoordsLoc;
